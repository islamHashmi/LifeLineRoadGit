...
{
    public partial class ConsigneeMaster : System.Web.UI.Page
    {
        ...
        protected void btnList_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("~/ContentPages/ConsigneeMasterList.aspx");
            }
            catch (Exception)
            {
                throw;
        ...
        {
            Consignee_Master obj = new Consignee_Master();

            obj.consigneeName = string.IsNullOrWhiteSpace(txtCompanyName.Text) ? null : txtCompanyName.Text;
            ...
            context.AddToConsignee_Master(obj);
        }

        private void ModifyData(LifeLineDbContext context, int id)
        {
            var obj = context.Consignee_Master.First(x => x.consigneeId == id);
        ...
        private void GetData(int id)
        {
            ...
            var com = context.Consignee_Master.First(x => x.consigneeId == id);

            ViewState["Id"] = com.consigneeId;

            txtCompanyName.Text = com.consigneeName;
